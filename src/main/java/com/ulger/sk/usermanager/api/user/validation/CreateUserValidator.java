...
public class CreateUserValidator implements UserValidator {
    ...
    public CreateUserValidator(EmailValidator emailValidator, PasswordPolicyManager passwordPolicyManager) {
        this(emailValidator, passwordPolicyManager, new DefaultI18NHelper());
    }

    public CreateUserValidator(EmailValidator emailValidator, PasswordPolicyManager passwordPolicyManager, I18NHelper i18NHelper) {
    ...
    private class CreateValidationHelper extends ValidationHelper {
        ...
        boolean validateId() {
            if (!Objects.isNull(modificationData.getId())) {
                addError(UserField.USERNAME, i18NHelper.getMessage("validation.id.notblank"));
                return false;
            }
